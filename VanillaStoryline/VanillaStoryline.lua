...
function storyline.Background:ConfigureFrame()
	...
	self.layer4.Banner = CreateFrame("Frame",nil,self.layer4)
		...
		self.layer4.Banner:SetPoint("TOP", 0, -260)
...
function storyline.Gossip:ConfigureFrame()
	...
	self.Frame = CreateFrame("Frame",nil,storyline.Background.layer5)
		...
		self.Frame:SetPoint("LEFT",-160,20)
...
function storyline.QuestDetail:ConfigureFrame()
	...
	local backdrop = {bgFile = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\ReadyCheck-Ready"}
		...
		self.GetQuest.Accept:SetPoint("LEFT",20,-110)
	...
	local backdrop = {bgFile = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\ReadyCheck-NotReady"}
		...
		self.GetQuest.Decline:SetPoint("RIGHT",-20,-110)
	...
	local backdrop = {bgFile = "Interface\\FriendsFrame\\FriendsFrameScrollIcon"}
		...
		self.GetQuest.CenterItem:SetPoint("CENTER",0,-110)
	...
	local backdrop = {bgFile = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\PandarenTrainingLarge_Circular_Frame"}
		...
		self.GetQuest.CenterRing:SetPoint("CENTER",0,-110)
...
function storyline.QuestProgress:ConfigureFrame()
	...
	-- Hide only the background texture
		self.Mainframe.Objective:SetBackdrop(nil)
...
-- Hide only the background texture
self.Mainframe.Reward:SetBackdrop(nil)
...
function storyline.Player:ConfigureFrame()
	...
	self.PlayerFrame = CreateFrame("PlayerModel", nil, storyline.Background.layer3)
		self.PlayerFrame:SetPoint("BOTTOM",self.Background)
		self.PlayerFrame:SetWidth(700)
		self.PlayerFrame:SetHeight(600)
		self.PlayerFrame:SetUnit("player")
		self.PlayerFrame:SetFacing(0.8)
		self.PlayerFrame:SetPoint("BOTTOM",-150,23)
...
function storyline.NPC:ConfigureFrame()
	...
	self.PlayerFrame = CreateFrame("PlayerModel", nil, storyline.Background.layer3)
		...
		self.PlayerFrame:SetFacing(-0.8)
		self.PlayerFrame:SetPoint("BOTTOM",100,23)
...
function storyline.Text:ConfigureFrame()
	...
	self.Questtext.Complete = storyline.Background.layer5.Questtext:CreateFontString(nil, "OVERLAY")
		self.Questtext.Complete:SetPoint("BOTTOM", 0, -15) --Shifted Down, below the frame
...
function storyline:ProgressQuest()
	...
	storyline.Background.layer5.Questtext.Fade.Button:SetScript("OnLeave",function() 
											storyline.Background.layer5.Questtext:SetBackdropBorderColor(1,1,1,1) 
											storyline.Text.Questtext.Continue:SetTextColor(1,1,0.4)
											end)
...
function storyline:ProgressQuestObjectives()
	...
	if IsQuestCompletable() then
		storyline.Background.layer5.Questtext.Fade.Button:SetScript("OnEnter",function()
											storyline.Background.layer5.Questtext:SetBackdropBorderColor(0,1,0,1)
											storyline.Text.Questtext.Complete:SetTextColor(0,1,0)
											end)
		storyline.Background.layer5.Questtext.Fade.Button:SetScript("OnLeave",function() 
											storyline.Background.layer5.Questtext:SetBackdropBorderColor(1,1,1,1)
											storyline.Text.Questtext.Complete:SetTextColor(1,1,0.4)
											end)
...
function storyline:UpdateModels()
	...
	storyline.Player.PlayerFrame:SetModelScale(2.5)
	storyline.Player.PlayerFrame:SetPosition(0, -0.08, -2.7)
	
	local model = storyline.Player.PlayerFrame:GetModel()
	if model == "Character\\BloodElf\\Female\\BloodElfFemale" then storyline.Player.PlayerFrame:SetPosition(0, -0.2, -1.18);storyline.Player.PlayerFrame:SetModelScale(1.4) --BloodElfFemale
	elseif model == "Character\\BloodElf\\Male\\BloodElfMale" then storyline.Player.PlayerFrame:SetPosition(0,-0.09,-1.4);storyline.Player.PlayerFrame:SetModelScale(1.5) --BloodElfMale
	elseif model == "Character\\Dwarf\\Female\\DwarfFemale" then storyline.Player.PlayerFrame:SetPosition(0,-0.19,-0.58);storyline.Player.PlayerFrame:SetModelScale(1) --DwarfFemale
	elseif model == "Character\\Dwarf\\Male\\DwarfMale" then storyline.Player.PlayerFrame:SetPosition(0,-0.09,-0.7);storyline.Player.PlayerFrame:SetModelScale(1) --DwarfMale
	elseif model == "Character\\Gnome\\Female\\GnomeFemale" then storyline.Player.PlayerFrame:SetPosition(0,-0.1,-0.22);storyline.Player.PlayerFrame:SetModelScale(0.6) --GnomeFemale
	elseif model == "Character\\Gnome\\Male\\GnomeMale" then storyline.Player.PlayerFrame:SetPosition(0,-0.1,-0.22);storyline.Player.PlayerFrame:SetModelScale(0.6) --GnomeMale
	elseif model == "Character\\Goblin\\Female\\GoblinFemale" then storyline.Player.PlayerFrame:SetPosition(0,-0.1,-0.7);storyline.Player.PlayerFrame:SetModelScale(1.1) --GoblinFemale
	elseif model == "Character\\Goblin\\Male\\GoblinMale" then storyline.Player.PlayerFrame:SetPosition(0,-0.08,-0.4);storyline.Player.PlayerFrame:SetModelScale(0.85) --GoblinMale
	elseif model == "Character\\Human\\Female\\HumanFemale" then storyline.Player.PlayerFrame:SetPosition(0,-0.19,-1.08);storyline.Player.PlayerFrame:SetModelScale(1.35) --HumanFemale
	elseif model == "Character\\Human\\Male\\HumanMale" then storyline.Player.PlayerFrame:SetPosition(0,0.05,-1.25);storyline.Player.PlayerFrame:SetModelScale(1.5) --HumanMale
	elseif model == "Character\\NightElf\\Female\\NightElfFemale" then storyline.Player.PlayerFrame:SetPosition(0, -0.12, -2);storyline.Player.PlayerFrame:SetModelScale(1.91) --NightElfFemale
	elseif model == "Character\\NightElf\\Male\\NightElfMale" then storyline.Player.PlayerFrame:SetPosition(0,0.07,-1.38);storyline.Player.PlayerFrame:SetModelScale(1.6) --NightElfMale
	elseif model == "Creature\\Wisp\\Wisp" then storyline.Player.PlayerFrame:SetPosition(0,-0.25,1);storyline.Player.PlayerFrame:SetModelScale(0.1) -- ok
	elseif model == "Character\\Orc\\Female\\OrcFemale" then storyline.Player.PlayerFrame:SetPosition(0, -0.05, -1.1);storyline.Player.PlayerFrame:SetModelScale(1.4) --OrcFemale
	elseif model == "Character\\Orc\\Male\\OrcMale" then storyline.Player.PlayerFrame:SetPosition(0, -0.1, -0.7);storyline.Player.PlayerFrame:SetModelScale(1.2) --OrcMale
	elseif model == "Character\\Scourge\\Female\\ScourgeFemale" then storyline.Player.PlayerFrame:SetPosition(0, -0.16, -1.57);storyline.Player.PlayerFrame:SetModelScale(1.7) --ScourgeFemale
	elseif model == "Character\\Scourge\\Male\\ScourgeMale" then storyline.Player.PlayerFrame:SetPosition(0, -0.16, -0.9);storyline.Player.PlayerFrame:SetModelScale(1.2) --ScourgeMale
	elseif model == "Character\\Tauren\\Female\\TaurenFemale" then storyline.Player.PlayerFrame:SetPosition(0, -0.19, -0.7);storyline.Player.PlayerFrame:SetModelScale(1.3) --TaurenFemale
	elseif model == "Character\\Tauren\\Male\\TaurenMale" then storyline.Player.PlayerFrame:SetPosition(0, -0.3, -0.8);storyline.Player.PlayerFrame:SetModelScale(1.5) --TaurenMale
	elseif model == "Character\\Troll\\Female\\TrollFemale" then storyline.Player.PlayerFrame:SetPosition(0, -0.24	, -1);storyline.Player.PlayerFrame:SetModelScale(1.4) --TrollFemale
	elseif model == "Character\\Troll\\Male\\TrollMale" then storyline.Player.PlayerFrame:SetPosition(0, -0.3, -0.8);storyline.Player.PlayerFrame:SetModelScale(1.3) --TrollMale
	end
	
	-- set default parameters
	storyline.NPC.PlayerFrame:SetModelScale(1.5)
	storyline.NPC.PlayerFrame:SetPosition(0,0.3,-1.3)
	storyline.NPC.PlayerFrame:SetFacing(-0.9)
	...
	if model == "Interface\\Buttons\\talktomequestionmark" then storyline.NPC.PlayerFrame:SetPosition(0,-0.45,0.65);storyline.NPC.PlayerFrame:SetModelScale(0.4) -- ok with scalebug
	elseif model == "Creature\\GnomeSpidertank\\GnomeBot" then storyline.NPC.PlayerFrame:SetPosition(-4,-5.4,-2);storyline.NPC.PlayerFrame:SetModelScale(0.2) -- ok with scalebug		
		-- Onu from Darkshore used to test
	elseif model == "Creature\\AncientOfLore\\AncientofLore" then storyline.NPC.PlayerFrame:SetPosition(0,2.6,4);storyline.NPC.PlayerFrame:SetModelScale(0.35) -- ok with scalebug
		--Screecher spirits
	elseif model == "Creature\\WindSerpent\\WindSerpent" then storyline.NPC.PlayerFrame:SetPosition(0,0.5,1.0) 
		--Spirit healer
	elseif model == "Creature\\spirithealer\\SpiritHealer" then storyline.NPC.PlayerFrame:SetFacing(-0.9);storyline.NPC.PlayerFrame:SetPosition(0,0.7,-1.35);storyline.NPC.PlayerFrame:SetModelScale(0.8)
		--Playable Races
	elseif model == "Character\\BloodElf\\Female\\BloodElfFemale" then storyline.NPC.PlayerFrame:SetPosition(0,0.28,-1.18);storyline.NPC.PlayerFrame:SetModelScale(1.4) -- ok	
	elseif model == "Character\\BloodElf\\Male\\BloodElfMale" then storyline.NPC.PlayerFrame:SetPosition(0,0.25,-1.4);storyline.NPC.PlayerFrame:SetModelScale(1.5) -- o
	elseif model == "Character\\Dwarf\\Female\\DwarfFemale" then storyline.NPC.PlayerFrame:SetPosition(0,0.2,-0.55);storyline.NPC.PlayerFrame:SetModelScale(1) -- ok
	elseif model == "Character\\Dwarf\\Male\\DwarfMale" then storyline.NPC.PlayerFrame:SetPosition(0,0.15,-0.7);storyline.NPC.PlayerFrame:SetModelScale(1) -- ok
	elseif model == "Character\\Gnome\\Female\\GnomeFemale" then storyline.NPC.PlayerFrame:SetPosition(0,0.1,-0.15);storyline.NPC.PlayerFrame:SetModelScale(0.6) -- ok
	elseif model == "Character\\Gnome\\Male\\GnomeMale" then storyline.NPC.PlayerFrame:SetPosition(0,0.125,-0.15);storyline.NPC.PlayerFrame:SetModelScale(0.6) -- ok
	elseif model == "Character\\Goblin\\Female\\GoblinFemale" then storyline.NPC.PlayerFrame:SetPosition(0,0.18,-0.48);storyline.NPC.PlayerFrame:SetModelScale(0.9) --GoblinFemale
	elseif model == "Character\\Goblin\\Male\\GoblinMale" then storyline.NPC.PlayerFrame:SetPosition(0,0.18,-0.31);storyline.NPC.PlayerFrame:SetModelScale(0.78) --GoblinMale
	elseif model == "Character\\Human\\Female\\HumanFemale" then storyline.NPC.PlayerFrame:SetPosition(0,0.27,-0.89);storyline.NPC.PlayerFrame:SetModelScale(1.2) -- ok
	elseif model == "Character\\Human\\Male\\HumanMale" then storyline.NPC.PlayerFrame:SetPosition(0,0.15,-1);storyline.NPC.PlayerFrame:SetModelScale(1.3) -- ok
	elseif model == "Character\\NightElf\\Female\\NightElfFemale" then storyline.NPC.PlayerFrame:SetPosition(0,0.17,-1.55);storyline.NPC.PlayerFrame:SetModelScale(1.6) -- ok
	elseif model == "Character\\NightElf\\Male\\NightElfMale" then storyline.NPC.PlayerFrame:SetPosition(0,0.125,-1.1);storyline.NPC.PlayerFrame:SetModelScale(1.4) -- ok
	elseif model == "Character\\Orc\\Female\\OrcFemale" then storyline.NPC.PlayerFrame:SetPosition(0, 0.12, -0.83);storyline.NPC.PlayerFrame:SetModelScale(1.2) --OrcFemale
	elseif model == "Character\\Orc\\Male\\OrcMale" then storyline.NPC.PlayerFrame:SetPosition(0, 0.3, -0.6);storyline.NPC.PlayerFrame:SetModelScale(1.1) --OrcMale
	elseif model == "Character\\Scourge\\Female\\ScourgeFemale" then storyline.NPC.PlayerFrame:SetPosition(0, 0.3, -1.3);storyline.NPC.PlayerFrame:SetModelScale(1.5) --ScourgeFemale
	elseif model == "Character\\Scourge\\Male\\ScourgeMale" then storyline.NPC.PlayerFrame:SetPosition(0, 0.125, -0.9);storyline.NPC.PlayerFrame:SetModelScale(1.2) --ScourgeMale
	elseif model == "Character\\Tauren\\Female\\TaurenFemale" then storyline.NPC.PlayerFrame:SetPosition(0,0.5,-0.45);storyline.NPC.PlayerFrame:SetModelScale(1.1) --TaurenFemale
	elseif model == "Character\\Tauren\\Male\\TaurenMale" then storyline.NPC.PlayerFrame:SetPosition(0,0.5,-0.7);storyline.NPC.PlayerFrame:SetModelScale(1.4) -- TaurenMale
	elseif model == "Character\\Troll\\Female\\TrollFemale" then storyline.NPC.PlayerFrame:SetPosition(0.0,0,-0.7);storyline.NPC.PlayerFrame:SetModelScale(1.2) -- TrollFemale
	elseif model == "Character\\Troll\\Male\\TrollMale" then storyline.NPC.PlayerFrame:SetPosition(0, 0.37, -0.7);storyline.NPC.PlayerFrame:SetModelScale(1.2) -- TrollMale
	-- Humanoids
	elseif model == "Creature\\CrackElf\\CrackElfMale" then storyline.NPC.PlayerFrame:SetPosition(0,0.09,-1.13);storyline.NPC.PlayerFrame:SetModelScale(1.23) -- 
	elseif model == "Creature\\Dryad\\Dryad" then storyline.NPC.PlayerFrame:SetFacing(-0.4);storyline.NPC.PlayerFrame:SetPosition(0,0.25,-1);storyline.NPC.PlayerFrame:SetModelScale(1.0)
	elseif model == "Creature\\bloodelfguard\\highelfelfmale_guard" then storyline.NPC.PlayerFrame:SetFacing(-0.55);storyline.NPC.PlayerFrame:SetPosition(0,0.25,-1.4);storyline.NPC.PlayerFrame:SetModelScale(1.5) -- Alah'Thalas Sentinel
	elseif model == "Creature\\Cryptlord\\CryptLord" then storyline.NPC.PlayerFrame:SetFacing(-0.55);storyline.NPC.PlayerFrame:SetPosition(0,0.25,-1.4);storyline.NPC.PlayerFrame:SetModelScale(1.5)
	elseif model == "Creature\\Kaelthas_Broken\\Kael'ThasBroken" then storyline.NPC.PlayerFrame:SetFacing(-0.55);storyline.NPC.PlayerFrame:SetPosition(0,0.25,-1.4);storyline.NPC.PlayerFrame:SetModelScale(1.5)
	elseif model == "Creature\\Kaelthas_Broken\\witheredking" then storyline.NPC.PlayerFrame:SetPosition(0,0.25,-1.4);storyline.NPC.PlayerFrame:SetModelScale(1.5)
	elseif model == "Creature\\HighElf\\HighElfMale_Hunter" then storyline.NPC.PlayerFrame:SetFacing(-0.55);storyline.NPC.PlayerFrame:SetPosition(0,0.25,-1.4);storyline.NPC.PlayerFrame:SetModelScale(1.5)
	elseif model == "Creature\\HighElf\\HighElfMale_Mage" then storyline.NPC.PlayerFrame:SetFacing(-0.55);storyline.NPC.PlayerFrame:SetPosition(0,0.25,-1.4);storyline.NPC.PlayerFrame:SetModelScale(1.5) -- ok
	elseif model == "Creature\\HighElf\\HighElfMale_Priest" then storyline.NPC.PlayerFrame:SetFacing(-0.55);storyline.NPC.PlayerFrame:SetPosition(0,0.25,-1.4);storyline.NPC.PlayerFrame:SetModelScale(1.5) -- ok
	elseif model == "Creature\\HighElf\\HighElfMale_Warrior" then storyline.NPC.PlayerFrame:SetPosition(-2,2.4,0.7) -- ok
	...
	elseif model == "Creature\\Ogre\\Ogre" then storyline.NPC.PlayerFrame:SetFacing(-0.7);storyline.NPC.PlayerFrame:SetPosition(0,0.45,-0.75);storyline.NPC.PlayerFrame:SetModelScale(1.2) -- ok
	elseif model == "Creature\\OgreMage\\OgreMage" then storyline.NPC.PlayerFrame:SetFacing(-1);storyline.NPC.PlayerFrame:SetPosition(0,0.28,0);storyline.NPC.PlayerFrame:SetModelScale(0.8) -- Chok'Garok
	...
	elseif model == "Creature\\Gnoll\\gnoll" then storyline.NPC.PlayerFrame:SetPosition(0,0.5,1.2);storyline.NPC.PlayerFrame:SetModelScale(1) -- ok	
	elseif model == "Creature\\GnollCaster\\GnollCaster" then storyline.NPC.PlayerFrame:SetFacing(-0.55);storyline.NPC.PlayerFrame:SetPosition(0,0,0.7);storyline.NPC.PlayerFrame:SetModelScale(0.4) -- Gnoll Caster
	elseif model == "Creature\\Centaur\\CentaurCaster" then storyline.NPC.PlayerFrame:SetFacing(-0.55);storyline.NPC.PlayerFrame:SetPosition(0,0.85,-0.4);storyline.NPC.PlayerFrame:SetModelScale(1)
	-- Animals
	elseif model == "Creature\\RidingWyvern\\ridingwyvern" then storyline.NPC.PlayerFrame:SetPosition(0, 0.2, -0.4);storyline.NPC.PlayerFrame:SetModelScale(0.9) -- ok
	elseif model == "CREATURE\\Wyvern\\Wyvern_Mount" then storyline.NPC.PlayerFrame:SetPosition(0, 0.2, -0.4);storyline.NPC.PlayerFrame:SetModelScale(2) -- ok
	elseif model == "CREATURE\\Wyvern\\Wyvern" then storyline.NPC.PlayerFrame:SetPosition(0, 0.2, -0.4);storyline.NPC.PlayerFrame:SetModelScale(2) -- ok
	elseif model == "CREATURE\\EliteWyvern\\EliteWyvern" then storyline.NPC.PlayerFrame:SetPosition(0, 0.2, -0.4);storyline.NPC.PlayerFrame:SetModelScale(2) -- ok
	elseif model == "Creature\\Chicken\\Chicken" then storyline.NPC.PlayerFrame:SetPosition(0, 0.2, -0.4);storyline.NPC.PlayerFrame:SetModelScale(0.75) -- ok
	elseif model == "Creature\\Sheep\\Sheep" then storyline.NPC.PlayerFrame:SetPosition(0, 0.2, -0.4);storyline.NPC.PlayerFrame:SetModelScale(0.75) -- ok
	elseif model == "Creature\\Sheep\\SheepBlack" then storyline.NPC.PlayerFrame:SetPosition(0, 0.2, -0.4);storyline.NPC.PlayerFrame:SetModelScale(0.7) -- ok
	elseif model == "Creature\\Sheep\\SheepBrown" then storyline.NPC.PlayerFrame:SetPosition(0, 0, -2);storyline.NPC.PlayerFrame:SetModelScale(1) -- ok
	elseif model == "Creature\\Sheep\\SheepRobo" then storyline.NPC.PlayerFrame:SetPosition(0, 0, -2);storyline.NPC.PlayerFrame:SetModelScale(1) -- ok
	elseif model == "Creature\\Gryphon\\Gryphon" then storyline.NPC.PlayerFrame:SetPosition(0, 0, -2);storyline.NPC.PlayerFrame:SetModelScale(0.5) -- ok
	elseif model == "Creature\\Hippogryph\\Hippogryph" then storyline.NPC.PlayerFrame:SetPosition(0, 0, -2);storyline.NPC.PlayerFrame:SetModelScale(0.5) -- ok
	...
	elseif model == "CREATURE\\DireWolf\\RidingDireWolf" then storyline.NPC.PlayerFrame:SetPosition(0, 0.2, -0.4);storyline.NPC.PlayerFrame:SetModelScale(1) -- ok
	-- Monsters
	elseif model == "Creature\\FlyingMachineCreature\\FlyingMachineCreature" then storyline.NPC.PlayerFrame:SetPosition(0,1.8,0.2);storyline.NPC.PlayerFrame:SetModelScale(0.1)
	elseif model == "Creature\\Flyingmachinecreature_vehicle\\flyingmachinecreature_vehicle" then storyline.NPC.PlayerFrame:SetPosition(0,1.8,0.2);storyline.NPC.PlayerFrame:SetModelScale(0.1)
	elseif model == "Creature\\AncientOfWar\\AncientofWar" then storyline.NPC.PlayerFrame:SetPosition(0,1.8,0.2);storyline.NPC.PlayerFrame:SetModelScale(0.6)
	...
	elseif model == "Creature\\FleshGolem\\FleshGolem" then storyline.NPC.PlayerFrame:SetPosition(0,2,-3.3); storyline.NPC.PlayerFrame:SetModelScale(2.8)-- ok with scalebug
	...
	elseif model == "Creature\\Dreadlord\\DreadLord" then storyline.NPC.PlayerFrame:SetFacing(-1.2);storyline.NPC.PlayerFrame:SetPosition(0,1.5,-2.6);storyline.NPC.PlayerFrame:SetModelScale (2.5) -- ok with big scalebug
	...
	elseif model == "Creature\\Golem\\Golem" then storyline.NPC.PlayerFrame:SetPosition(0,0.5,1); storyline.NPC.PlayerFrame:SetModelScale(0.45)
	elseif model == "Creature\\GolemHarvestStage2\\GolemHarvestStage2" then storyline.NPC.PlayerFrame:SetPosition(0,0.32,0.55); storyline.NPC.PlayerFrame:SetModelScale(0.35)
	elseif model == "Creature\\GolemHarvest\\GolemHarvest" then storyline.NPC.PlayerFrame:SetPosition(0,0.5,1.8); storyline.NPC.PlayerFrame:SetModelScale(0.2)
	...
	-- Kids
	elseif model == "Creature\\HumanFemaleKid\\HumanFemaleKid" then storyline.NPC.PlayerFrame:SetFacing(-1);storyline.NPC.PlayerFrame:SetPosition(0,0.25,-0.7);storyline.NPC.PlayerFrame:SetModelScale(1)
	elseif model == "Creature\\HumanMaleKid\\HumanMaleKid" then storyline.NPC.PlayerFrame:SetFacing(-1);storyline.NPC.PlayerFrame:SetPosition(0,0.25,-0.7);storyline.NPC.PlayerFrame:SetModelScale(1)
	elseif model == "Creature\\OrcFemaleKid\\OrcFemaleKid" then storyline.NPC.PlayerFrame:SetFacing(-1);storyline.NPC.PlayerFrame:SetPosition(0,0.25,-0.7);storyline.NPC.PlayerFrame:SetModelScale(1)
	elseif model == "Creature\\OrcMaleKid\\OrcMaleKid" then storyline.NPC.PlayerFrame:SetFacing(-1);storyline.NPC.PlayerFrame:SetPosition(0,0.25,-0.7);storyline.NPC.PlayerFrame:SetModelScale(1)
...
function storyline:ResetModels()
	...
	storyline.Player.PlayerFrame:SetPosition(0, 0, 0)
end
...
storyline.Area = {}
	...
	storyline.Area["Tirisfal Glades"]={[11]="Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\TirisfallGlades"} 
	...
	storyline.Area["Thousand Needles"]={[11]="Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\ThousandNeedles"} 
	...
	storyline.Area["Desolace"]={[11]="Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\Desolace"} 
	...
	storyline.Area["Badlands"]={[11]="Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\Badlands",} 
	storyline.Area["Swamp of Sorrows"]={[11]="Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\SwampofSorrows"} 
	...
	storyline.Area["Azshara"]={[11]="Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\Azshara"} 
	storyline.Area["Blasted Lands"]={[11]="Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\BlastedLands"} 
	...
	storyline.Area["Darnassus"]={[11]="Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\Darnassus"} 
	storyline.Area["City of Ironforge"]={[11]="Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\Ironforge"}	
	storyline.Area["Orgrimmar"]={[11]="Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\Orgrimmar"} 
	storyline.Area["Stormwind City"]={[11]="Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\StormwindCity"}	
	storyline.Area["Thunder Bluff"]={[11]="Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\ThunderBluff"} 
